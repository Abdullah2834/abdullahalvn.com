...
<form name="contact" id="contactForm" method="post">
    <div class="frm-cntr">
        <div class="frm-blk">
            <div class="frm-itm">
        ...
        <div class="frm-txt">
            ...
            <textarea class="txtArea" on:input={autoHeightTxtArea} bind:this={txtArea} name="message" placeholder="Enter your needs"></textarea>
        </div>
